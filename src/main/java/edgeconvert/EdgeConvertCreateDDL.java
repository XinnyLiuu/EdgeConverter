...
public abstract class EdgeConvertCreateDDL {
    ...
    protected EdgeTable[] tables; //master copy of POJOs.EdgeTable objects
    protected EdgeField[] fields; //master copy of POJOs.EdgeField objects
    ...
    public EdgeConvertCreateDDL(EdgeTable[] tables, EdgeField[] fields) {
        ...
        this.fields = fields;
        initialize();
    } //EdgeConvert.EdgeConvertCreateDDL(POJOs.EdgeTable[], POJOs.EdgeField[])
    ...
    } //EdgeConvert.EdgeConvertCreateDDL()
